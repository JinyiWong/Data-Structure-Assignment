...
// =========================
// Windows (MinGW/GCC):
//   g++ -std=c++17 array_listB.cpp -o array_listB -lpsapi
// 
// Windows (Clang):
//   clang++ -std=c++17 array_listB.cpp -o array_listB -lpsapi
//
// Windows (MSVC):
//   cl /EHsc /std:c++17 array_listB.cpp psapi.lib
//
// macOS:
//   clang++ -std=c++17 array_listB.cpp -o array_listB
//
// Linux:
//   g++ -std=c++17 array_listB.cpp -o array_listB
//
#define NOMINMAX
#include <windows.h>
#include <psapi.h>
